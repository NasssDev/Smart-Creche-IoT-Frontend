                        ...
                        <div className="overflow-hidden border border-gray-200">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">Air conditioning
                                    </td>
                                    <td className="px-4 py-4 text-sm text-gray-500 whitespace-nowrap">Adjusted
                                        temperature
                                    </td>
