        ...
        <div className='w-full max-w-xl'>
            <Card className="w-400 rounded-3xl shadow-lg">
                ...
                <div className="flex items-center">
                    ...
                    &nbsp;
                    &nbsp;
                    <span className="text-xl">Movement Detection</span>
                </div>
                <br />
                <div className="flex items-center">
                    <Switch
                    ...
                    &nbsp;
                    &nbsp;
                    <span className="text-xl">Temperature Alert</span>
                </div>
                <br />
                <div className="flex items-center">
                    <Switch
                    ...
                    &nbsp;
                    &nbsp;
                    <span className="text-xl">CO2 Alert</span>
                </div>
                <br />
                <div className="flex items-center">
                    <Switch
                    ...
                    &nbsp;
                    &nbsp;
                    <span className="text-xl">Humidity Alert</span>
                </div>
                <br />
                <div className="flex items-center">
                    <Switch
                    ...
                    &nbsp;
                    &nbsp;
                    <span className="text-xl">High Noise Alert</span>
                </div>
                <br />
                <div className="flex items-center">
                    <Switch
                    ...
                    &nbsp;
                    &nbsp;
                    <span className="text-xl">Water Leak Alert</span>
                </div>
            </Card>
        </div>
    );
