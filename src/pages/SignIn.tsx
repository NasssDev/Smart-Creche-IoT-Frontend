        ...
        <form className="max-w-sm mx-auto">
          ...
          <div className="mb-4 flex items-center justify-between">
            <div className="flex items-center">
              <input type="checkbox" className="h-4 w-4 text-blue-200 focus:ring-blue-500 border-gray-200 rounded" id="KeepMeLoggedIn" />
              <label htmlFor="KeepMeLoggedIn" className="ml-2 block text-sm text-gray-600">
                Keep me logged in
              </label>
            </div>
            <a className="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-600" href="#">Forget password?</a>
          </div>
          <div className="mb-4">
          ...
          <div className="flex items-center">
            ...
            <a className="inline-block align-baseline text-sm text-blue-500 hover:text-blue-800" href="#">Create an Account</a>
          </div>
