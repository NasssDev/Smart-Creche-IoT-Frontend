...
export const ForgetPasswordChange = () => {
    ...
    const [forgetPasswordChangeFormData, setforgetPasswordChangeFormData] = useState({ password: '', confirmpassword: '', });

    function handleChange(event: ChangeEvent<HTMLInputElement>) {
        setforgetPasswordChangeFormData(prevState => {
            return {
                ...prevState,
        ...
        <>
            <div className="flex justify-center items-center h-screen">
                <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        <button className="rounded-md py-2 px-6 text-md inline-table w-full items-center text-center bg-gray-500 text-white" type="submit">Back</button>
                    </div>
